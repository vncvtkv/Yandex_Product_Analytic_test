...
https://datalens.ru/wizard/b80075cfh81iv-novyy-dataset-lineychataya-diagramma
...
Обратимя к запросам с десктопа. Основные характеристики:
...
**Итог**: 
Дадим такое определение - тему будем называть контрастной, если количество запросов по данной теме отличается по крайней мере в два раза на разных платформах.
Для выявления подобный тематик воспользуемся топом запросов, который мы уже находили, попытаемся классифицировать запросы - разбить на тематики близкие по некоторой мере. 
![Сравнение десктоп и мобильных](image/img_4.jpg)
